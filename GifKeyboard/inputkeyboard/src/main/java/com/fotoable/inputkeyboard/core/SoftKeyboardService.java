...
public class SoftKeyboardService extends InputMethodService
    ...
    public void onCreate() {
        super.onCreate();
        KeyBoardSwitcher.getInstance().init(this);
    ...
    public void onInitializeInterface() {
        ...
        mSymbolsShiftedKeyboard = new LatinKeyboard(this, R.xml.symbols);
    }
    ...
    public View onCreateInputView() {
        ...
        View rootView = keyBoardSwitcher.onCreateInputView();
    ...
    public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        currentPackage = attribute.packageName;
